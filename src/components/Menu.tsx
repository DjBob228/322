              ...
              <div className="space-y-4 text-white/90 text-sm">
                ...
                <div>
                  ...
                  <div className="text-white/80 text-sm space-y-2">
                    <p>Погоны — это <strong>пара некозырных шестёрок</strong> в последнем ходе. Если атакующий выкладывает эти карты, они автоматически засчитываются — <strong>отбить их нельзя</strong>. Проигравший объявляется "дураком с погонами".</p>
                    <p className="text-white/60 text-xs">Ключевое условие: ровно 2 некозырные шестёрки в последнем ходе.</p>
                  </div>
                </div>
              </div>
